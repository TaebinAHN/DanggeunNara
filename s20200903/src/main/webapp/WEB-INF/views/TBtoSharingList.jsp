...
<html lang="ko">
    ...
    <body>
        ...
        <section class="section">
            <div class="to-Sharing-list">
                <h1 class="list-title">내 나눔내역</h1>
                <div class="to-Sharing-list__container">
                    <h2 class="to-Sharing-list__title">거래가능</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 나눔내역 없을때 띄우기 -->
                    <!-- <div class="to-Sharing-list__text">
                        <strong>나눔 내역이 없어요 !</strong>
                        <a href="../board/toSharingBoard.html"
                            ><p>구경가기</p>
                        </a>
                    </div> -->
                    <!-- 나눔내역 있을떄 -->
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <div class="to-Sharing-list__content">
                        <!-- 태그 안에 있는 더미 데이터들은 틀을 보기 위함이며 실제 작업시엔 해당 데이터를 불러 올 수 있도록 변경 부탁드립니다. -->
                        <article class="to-Sharing-list__article">
                            <a href="../board/toSharingBoardRead.html">
                                <div class="to-Sharing-list__content--thumbnail">
                                    <img
                                ...
                                <div class="to-Sharing-list__content--text">
                                    <h1
                                        class="to-Sharing-list__content--text__title"
                                    >
                                        5단 서랍장 입니다
                                    </h1>
                                    <p
                                        class="to-Sharing-list__content--text__address"
                                    >
                                        서울 송파구 석촌동
                                    </p>
                                    <div
                                        class="to-Sharing-list__content--text__date"
                                    >
                                        <div class="to-Sharing-list__content--date">
                                            2020.09.26
                                        </div>
                                        <div class="to-Sharing-list__content--hit">
                                            조회수 30
                                        </div>
                                    </div>
                                    <div
                                        class="to-Sharing-list__content--text__price"
                                    >
                                        <div class="to-Sharing-list__content--price">
                                            무료나눔
                                        </div>
                                        <div class="to-Sharing-list__content--picks">
                                            <img
                    ...
                    <div class="to-Sharing-list__page-num-container">
                ...
                <div class="to-Sharing-list__container">
                    <h2 class="to-Sharing-list__title">거래중</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 나눔내역 없을때 띄우기 -->
                    <div class="to-Sharing-list__text">
                        <strong>나눔 내역이 없어요 !</strong>
                ...
                <div class="to-Sharing-list__container">
                    <h2 class="to-Sharing-list__title">거래완료</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 나눔내역 없을때 띄우기 -->
                    <div class="to-Sharing-list__text">
                        <strong>나눔 내역이 없어요 !</strong>
                ...
                <div class="to-Sharing-list__container">
                    <h2 class="to-Sharing-list__title">당도측정</h1>
                        <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                        <!-- 측정내역 없을때 띄우기 -->
                        <!-- <div class="to-Sharing-list__text">
                        ...
                        <div class="to-Sharing-list__content">
                            <article class="to-Sharing-list__article">
                                <a href="../board/toSharingBoardRead.html">
                                    ...
                                    <div class="to-Sharing-list__content--text">
                                        <h1 class="to-Sharing-list__content--text__title">
                                            5단 서랍장 입니다
                                        </h1>
                                        <p class="to-Sharing-list__content--text__address">
                                            서울 송파구 석촌동
                                        </p>
                                        <div class="to-Sharing-list__content--text__date">
                                            <div class="to-Sharing-list__content--date">
                                                2020.09.26
                                            </div>
                                            <div class="to-Sharing-list__content--hit">
