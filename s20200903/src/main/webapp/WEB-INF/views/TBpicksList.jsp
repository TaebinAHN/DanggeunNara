    ...
    <body>
        ...
        <section class="section">
            <div class="picks-list">
                <h1 class="list-title">내 관심목록</h1>
                <div class="picks-list__container">
                    <h2 class="picks-list__title">판매중</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 관심목록없을때 띄우기 -->
                    <!-- <div class="picks-list__text">
                        <strong>관심있는 목록이 없어요 !</strong>
                    ...
                    <!-- 관심목록 있을때 -->
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <div class="picks-list__content">
                        <!-- 태그 안에 있는 더미 데이터들은 틀을 보기 위함이며 실제 작업시엔 해당 데이터를 불러 올 수 있도록 변경 부탁드립니다. -->
                        <article class="picks-list__article">
                            <a href="../board/toSaleBoardRead.html">
                                <div class="picks-list__content--thumbnail">
                                    <img
                                ...
                                <div class="picks-list__content--text">
                                    <h1
                                        class="picks-list__content--text__title"
                                    >
                                        5단 서랍장 입니다
                                    </h1>
                                    <p
                                        class="picks-list__content--text__address"
                                    >
                                        서울 송파구 석촌동
                                    </p>
                                    <div
                                        class="picks-list__content--text__date"
                                    >
                                        <div class="picks-list__content--date">
                                            2020.09.26
                                        </div>
                                        <div class="picks-list__content--hit">
                                            조회수 30
                                        </div>
                                    </div>
                                    <div
                                        class="picks-list__content--text__price"
                                    >
                                        <div class="picks-list__content--price">
                                            15,000원
                                        </div>
                                        <div class="picks-list__content--picks">
                                            <img
                    ...
                    <div class="picks-list__page-num-container">
                ...
                <div class="picks-list__container">
                    <h2 class="picks-list__title">나눔중</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 관심목록없을때 띄우기 -->
                    <div class="picks-list__text">
                        <strong>관심있는 목록이 없어요 !</strong>
                ...
                <div class="picks-list__container">
                    <h2 class="picks-list__title">구매합니다 ~!</h1>
                    <!-- 각 최신글 3개만 띄어주시면 됩니다 -->
                    <!-- 관심목록없을때 띄우기 -->
                    <!-- <div class="picks-list__text">
                        <strong>관심있는 목록이 없어요 !</strong>
